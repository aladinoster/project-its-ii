...
* Explore the relationship of the fundamental diagram  \@ref(fig:fdiag). Remember that this is a function defined for two different intervals. Knowing that $\phi = v\rho$ is a fundamental relationship on traffic, determine the relationship between $v$ and $\rho$. Is it possible to have a univoque relationship for all cases? 
